...
int main(int argc, char *argv[]) {
  ...
  ARACHNID_MAIN_ARGS.buflen = DEFAULT_BUFLEN;
  ARACHNID_MAIN_ARGS.flags = ARACHNID_MAIN_ARGS.specify_flags = 0;
  ARACHNID_MAIN_ARGS.nftw_flags = FTW_PHYS;
  ARACHNID_MAIN_ARGS.key = NULL;
  ARACHNID_MAIN_ARGS.path = ".";
  ...
  while ((opt = getopt_long(argc, argv, "-b:cCeihlnpsw:", longopts, NULL))
      != -1) {
    switch (opt) {
      case '\1':
